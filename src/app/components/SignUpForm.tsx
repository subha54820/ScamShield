...
import { UserPlus, User, Lock, Eye, EyeOff, Check } from 'lucide-react';
            ...
            <div>
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  required
                  className="pl-10 pr-10 h-12 bg-[#0a0e27] border-[#00d9ff]/30 text-white placeholder:text-gray-500 focus:border-[#00d9ff] focus:shadow-[0_0_15px_rgba(0,217,255,0.3)]"
                />
                <button
                  type="button"
